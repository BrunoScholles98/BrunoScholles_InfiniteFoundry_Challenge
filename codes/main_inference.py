...
def main():
    ...
    while True:
        ...
        cv2.putText(annotated, f"Pieces Picked - {picked_count}", (70, 180),
                    cv2.FONT_HERSHEY_SIMPLEX, 1.2, (255, 105, 180), 3, cv2.LINE_AA)
        cv2.putText(annotated, f"Pen Mark - {penmark_state['count']}", (70, 260),
                    cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0, 165, 255), 3, cv2.LINE_AA)
        cv2.putText(annotated, f"Probe Passes - {probe_state['count']}", (70, 340),
                    cv2.FONT_HERSHEY_SIMPLEX, 1.2, (0, 255, 100), 3, cv2.LINE_AA)
