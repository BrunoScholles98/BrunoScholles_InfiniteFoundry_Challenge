...
* **`src/inference/`** – Main inference logic. The core script of the challenge `main.py` loads the trained model and processes the input video, producing the output video with detections and overlays.
